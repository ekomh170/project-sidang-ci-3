<div class="container mb-2">
  ...
  <div class="card">
    <div class="card-body">
      <?= form_open_multipart('Ipk/tambah'); ?>
      ...
      <span style="float: right;">
        <button type="submit" class="btn btn-success"><a style="text-decoration: none; color: white;" href="<?= base_url('Ipk/index'); ?>">Kembali</a></button>
      </span>
    </div>
  </div>
</div>