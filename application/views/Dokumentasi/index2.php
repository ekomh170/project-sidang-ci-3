 					...
 					<div class="card-body p-0">
 						<div class="card">
 							...
 							<div class="card-body">
 								...
 								<h6 class="card-text text-left mb-4"><span class="font-weight-bold">Keterangan : </span> Dasbor adalah jenis antarmuka pengguna grafis yang sering memberikan pandangan sekilas tentang indikator kinerja utama yang relevan dengan tujuan atau proses bisnis tertentu. Dalam penggunaan lain, "dasbor" adalah nama lain untuk "laporan kemajuan" atau "laporan."  Dan Juga Dashboard Adalah Halaman utama yang menampilkan informasi tentang data data yang</h6>
 					...
 					<div class="card-body p-0">
 						<div class="card">
 							...
 							<div class="card-body">
 								...
 								<h6 class="card-text text-left mb-4"><span class="font-weight-bold">Keterangan : </span>Menu Transkrip Nilai adalah menu untuk menampung kumpulan data nilai Transkrip Nilai mahasiswa yang ingin di nilai oleh dosen</h6>

 								<h6 class="card-text text-left"><span class="font-weight-bold">Nama Menu : </span>Penilaian Nilai Akhir</h6>
 								<h6 class="card-text text-left mb-4"><span class="font-weight-bold">Keterangan : </span>Menu Nilai Akhir adalah menu untuk menampung kumpulan data nilai Nilai Akhir mahasiswa yang ingin di nilai oleh dosen</h6>
