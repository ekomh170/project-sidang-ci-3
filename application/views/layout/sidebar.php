<ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
  <!-- <ul class="navbar-nav sidebar sidebar accordion" id="accordionSidebar" style="background-color: white; "> -->
    ...
    <center>
      ...
      <a href="<?= base_url('Profile')?>"><button class="btn btn-info mb-2"><div class="mb-4 d-none d-lg-inline text-white-600 small text-white font-weight-bold"><?=$user['nama_panggilan'];?></div></button></a>
    </center>
    <hr class="sidebar-divider">
                    ...
                    <?php if ($this->uri->segment(1) == 'Auth'): ?>
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                          <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <?php if ($this->uri->segment(1) == 'Mahasiswa'): ?>
                              <a class="collapse-item active" href="<?=base_url();?>Mahasiswa">Mahasiswa</a>
                            <?php endif?>
                            <?php if ($this->uri->segment(1) != 'Mahasiswa'): ?>
                            ...
                            <?php if ($this->uri->segment(1) == 'Dosen'): ?>
                              <a class="collapse-item active" href="<?=base_url();?>Dosen">Dosen</a>
                            <?php endif?>
                            <?php if ($this->uri->segment(1) != 'Dosen'): ?>
                            ...
                            <?php if ($this->uri->segment(1) == 'Fakultas'): ?>
                              <a class="collapse-item active" href="<?=base_url();?>Fakultas">Fakultas</a>
                            <?php endif?>
                            <?php if ($this->uri->segment(1) != 'Fakultas'): ?>
                            ...
                            <?php if ($this->uri->segment(1) == 'Jurusan'): ?>
                              <a class="collapse-item active" href="<?=base_url();?>Jurusan">Jurusan</a>
                            <?php endif?>
                            <?php if ($this->uri->segment(1) != 'Jurusan'): ?>
                            ...
                            <?php if ($this->uri->segment(1) == 'TahunAkademik'): ?>
                              <a class="collapse-item active" href="<?=base_url();?>TahunAkademik">Tahun Akademik</a>
                            <?php endif?>
                            <?php if ($this->uri->segment(1) != 'TahunAkademik'): ?>
                            ...
                            <?php if ($this->uri->segment(1) == 'Matkul'): ?>
                              <a class="collapse-item active" href="<?=base_url();?>Matkul">Mata Kuliah</a>
                            <?php endif?>
                            <?php if ($this->uri->segment(1) != 'Matkul'): ?>
                            ...
                            <?php if ($this->uri->segment(1) == 'Kelas'): ?>
                              <a class="collapse-item active" href="<?=base_url();?>Kelas">Kelas</a>
                            <?php endif?>
                            <?php if ($this->uri->segment(1) != 'Kelas'): ?>
                            ...
                            <?php if ($this->uri->segment(1) == 'Ruangan'): ?>
                              <a class="collapse-item active" href="<?=base_url();?>Ruangan">Ruangan</a>
                            <?php endif?>
                            <?php if ($this->uri->segment(1) != 'Ruangan'): ?>
                        ...
                        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                          <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <?php if ($this->uri->segment(1) == 'KrsDetail'): ?>
                              <a class="collapse-item active" href="<?=base_url();?>KrsDetail">Penilaian KRS</a>
                            <?php endif?>
                            <?php if ($this->uri->segment(1) != 'KrsDetail'): ?>
                            ...
                            <?php if ($this->uri->segment(1) == 'Nilai'): ?>
                              <a class="collapse-item active" href="<?=base_url();?>Nilai">Penilaian Nilai Akhir</a>
                            <?php endif?>
                            <?php if ($this->uri->segment(1) != 'Nilai'): ?>
                            ...
                            <?php if ($this->uri->segment(1) == 'Ipk'): ?>
                              <a class="collapse-item active" href="<?=base_url();?>Ipk">Penilaian IPK</a>
                            <?php endif?>
                            <?php if ($this->uri->segment(1) != 'Ipk'): ?>
                            ...
                            <?php if ($this->uri->segment(1) == 'TranskripNilai'): ?>
                              <a class="collapse-item active" href="<?=base_url();?>TranskripNilai">Transkrip Nilai</a>
                            <?php endif?>
                            <?php if ($this->uri->segment(1) != 'TranskripNilai'): ?>
                      ...
                      <?php if ($this->uri->segment(1) != 'Role'): ?>
                        ...
                        <?php if ($this->uri->segment(1) == 'Role'): ?>
                          <li class="nav-item active">
                          <?php endif?>
                          <a class="nav-link pb-1" href="<?=base_url();?>Role">
                            <i class="fas fa-fw fa-user-cog"></i>
                            <span><b>Pengaturan Role</b></span></a>
                            <hr class="sidebar-divider">
                          </li>
                          <!-- =============================================== ADMIN =======================================-->
                        <?php }?>
