  ...
  <div class="card">
    <div class="card-body">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="nama_panggilan" name="nama_panggilan" placeholder="Masukan Nama Panggilan/Pendek" value="<?= set_value('nama_panggilan'); ?>">
      ...
      <div class="form-group">
        ...
        <input type="date" min="1000-01-01" max="2004-01-01" class="form-control" id="tanggal_lahir" name="tanggal_lahir" value="<?= set_value('tanggal_lahir'); ?>">
